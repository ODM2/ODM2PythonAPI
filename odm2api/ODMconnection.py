...
class SessionFactory():
    def __init__(self, connection_string, echo=True, version = 2.0):
        ...
        if 'sqlite' in connection_string:
            self.engine = create_engine(connection_string,  encoding='utf-8', echo=echo, pool_recycle=1000)
            self.test_engine = self.engine
        elif 'mssql' in connection_string:
            self.engine = create_engine(connection_string, encoding='utf-8', echo=echo, pool_recycle=1000)
            self.test_engine = create_engine(connection_string, encoding='utf-8', echo=echo, pool_recycle=1000,
