 ...
 #   ['mysql', 'localhost', 'odm2', 'ODM', 'odm'],
   ...
   [' mysql + mysqldb:', 'mysql', 'mysql+mysqldb://root@localhost/odm2'],
    ...
    ["mssql_pyodbc2_azure", "mssql",
     "mssql+pyodbc:///?odbc_connect=DRIVER%3DFreeTDS%3BSERVERNAME%3Dnrb8xkgxaj.database.windows.net%3BUID%3Dweb@nrb8xkgxaj%3BPWD%3D1Forgetit!%3BDATABASE%3Dodm2",
     'odm2', 'web', '1Forgetit!'],
    ["mssql_pyodbc3_azure", "mssql",
     "mssql+pyodbc:///?odbc_connect=DRIVER%3D{FreeTDS}%3BSERVERNAME%3Dnrb8xkgxaj.database.windows.net%3BUID%3Dweb%3DPWD%3D1Forgetit!%3BDATABASE%3Dodm2",
     'odm2', 'web', '1Forgetit!'],
    ...
    ["mssql_pyodbc_moonstone",   "mssql",
     ...
     'odm2', 'web', '1Forgetit!'],
    ["mssql_pyodbc2",   "mssql",
     "mssql+pyodbc:///?odbc_connect=DRIVER={FreeTDS};SERVERNAME=moonstone.ucsd.edu;UID=webservice;PWD=webservice;DATABASE=odm2",
     'odm2', 'web', '1Forgetit!'],
    ["pymssql_azre",   "mssql",
